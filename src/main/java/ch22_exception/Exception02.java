...
public class Exception02 {
    ...
    public static void login(String id, String password) throws LoginFailedException {
        ...
        String correctPassword = "1q2q3e4r";
...
//            System.out.println("ID 혹은 비밀번호를 확인하세요.");
            ...
            // argument로 하는 LoginFailedException 객체가 생성되었다고 할 수 있겠네.
        }
    }
...
//        login(inputId, inputPassword);      // 코드 작성 순서 잘 기억해라.
        // throws 키워드를 달게 되니까 여기에 오류 발생했다.
...
/*
    ...
    method의 정의 / 생성자 정의 / 객체 생성 방식이라는 우리가 이때까지
    배워온 코드 작성 방법과 차이가 없다는 것을 확인할 수 있다.
 */