...
/*
    ...
    6. studentCode, name, score를 매개변수로 하는 매개변수 생성자를 정의
        ...
        코드를 작성하시오
    7. StudentMain 클래스에 해당 객체명과 속셩명을 가질 수 있도록 작성하시오
    ...
    9. 실행 예
        기본 생성자로 객체가 생성되었습니다.
        int 매개변수 생성자로 객체를 생성했다.
        String 매개변수 생성자로 객체를 생성
        int, String 매개변수 생성자로 객체 생성
        int, String, double 매개변수 생성자로 객체 생성
