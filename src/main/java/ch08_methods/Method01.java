...
public class Method01 {
    ...
    public static void main(String[] args) {
        ...
        myName = scanner.nextLine();        // 사실 이 nextLine();이 메서드입니다. -> 메서드의 결과값을 myName 이라는
                                            // 변수에 저장했다.
        System.out.println("나이를 입력하세요 : ");
        myAge = scanner.nextInt();
        System.out.println(introduce(myName, myAge));       // 그리고 그 myName / myAge 라는 결과값을
                                                            // 우리가 정의한 introduce()메서드의 argument로 사용해
                                                            // 최종 결과물을 콘솔에 출력한다 .
    }
}
