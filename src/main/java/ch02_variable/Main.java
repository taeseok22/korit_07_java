...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
        거기서 오류가 하나라도 발생하게 되면 ㄷ전체 프로그램이 실행 X
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 오태석입니다. ");
//        System.out.println(안녕하세요, 제 이름은 오태석입니다.); // 오류발생
        ...
        String introduction = "안녕하세요, 저는 이번 국비 과정을 맡게 된 안근수 입니다. ";
        ...
        char name2 = '태';
        char name3 = '석';
        System.out.println(name1 + name2 + name3);  // 결과값 : 153629
        System.out.println('오' + '태' + '석');     // 결과값 : 153629

        System.out.println("" + name1 + name2 + name3);    // 결과값 : 오태석
        ...
        /*
            ...
            때문에 원하는 방식으로 출력되지 않습니다. 144 어쩌고로 출력됨.

            그렇게 때문에 74번 라인에서 sout()의 내부에 ""를 넣어주니까,
            원하는 결과값을 얻을 수 있었습니다.

            즉
            작은따옴표('')는 '문자'를 표시하기 위한 기호
            큰따옴표("")는 "문자열"을 표시하기 위한 기호
            라고 알아두시면 되겠습니다(근데 python 이랑 JavaScript 에서는 또 이런 구분이
            없습니다).
        ...
        Integer width5 = 500;
        Integer width6 = 600;
        System.out.println(width5 + width6);         // 근데 대문자로 시작하는 Integer 가 있긴 합니다.
...
//        int pi = 3.14;          // 오류 발생
        ...
        // 이상의 코드에서 알 수 있는 점은 변수 _ literal 의 형태로도 작성이 가능하다는 점입니다.
        ...
        /*
            ...
            제 전공은 어쩌고저쩌고 학과이며, mbti는 블라블라입니다. 열심히 할게요 !!!'
        ...
        System.out.println("저는 코리아 it 아카데미 7월 국비과정을 수강하고 있는 " + name10 + "입니다." + age10 +
                "살입니다.\n제 전공은 없습니다." + "mbti는" + mbti10 + "입니다. 열심히 할게요 !");
        // sout 두 번 써서 하는법
        System.out.println("저는 코리아 it 아카데미 7월 국비과정을 수강하고 있는 " + name10 + "입니다." + age10 + "살입니다.");
        System.out.println("제 전공은 없습니다." + "mbti는" + mbti10 + "입니다. 열심히 할게요 !");
