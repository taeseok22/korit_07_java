...
//    }
    ...
    // 자식 고유의 field에 대한 getter / setter 정의  부모꺼는 재정의 안할거면 상관없다.
    ...
    public void showInfo() {
        ...
        System.out.println("재고: " + stock);             // 두줄씩 코드라인의 차이가 생기는 이유에 대해 명확히 알길 추천한다.
    }
}
