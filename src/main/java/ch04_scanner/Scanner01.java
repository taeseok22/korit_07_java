...
//        System.out.println("이름 : " + name);
        ...
        /*
            ...
            그대로 넘어간다는 점입니다.
            왜 이런 문제가 생기냐면 nextInt()에서 값을 입력하고 저희가 enter을 치게 되는데,
            그 경우 다음 nextLine()에서는 enter 키를 받아들여서 빈값인 상태로 enter를 쳤다고
            인지하게 되기 때문에
...
//        System.out.println(name + "학생의 점수는 " + score + "입니다. ");
        ...
        System.out.println("풀이법 # 2 : nextLine()를 쓰는 방법");
