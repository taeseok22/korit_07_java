...
public class Samsung {
    ...
    private Samsung() {
        company = getClass().getSimpleName();       // 어차피 이거 결과값 Samsung 이다.
        serialNumber = 20250000;            // 즉 객체 생성시에 필드값을 초기화 시켰다.
    }
    ...
    public String createSerialNumber(String model) {
        ...
        // 않는다.
        // 그럼 정적 변수로 선언하고 다수의 삼성 객체를 만들어도 serialNumber가 안겹치지 않을까
        // 라고 질문 한다면 맞는 말 이다.
        // 근데 그럼 Samsung 이라는 회사 갯수가 백만개라는 전제하에 가능하겠네.
